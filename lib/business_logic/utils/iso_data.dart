...
class IsoData {
  ...
  static final Map<String, Map<String, String>> data = {
    ...
    'XBA': {'name': 'Bond Markets Unit European Composite Unit (EURCO)', 'flag': 'X'},
    'XBB': {'name': 'Bond Markets Unit European Monetary Unit (E.M.U.-6)', 'flag': 'X'},
    'XBC': {'name': 'Bond Markets Unit European Unit of Account 9 (E.U.A.-9)', 'flag': 'X'},
    'XBD': {'name': 'Bond Markets Unit European Unit of Account 17 (E.U.A.-17)', 'flag': 'X'},
    ...
    'XTS': {'name': 'Codes specifically reserved for testing purposes', 'flag': 'X'},
    'XUA': {'name': 'ADB Unit of Account', 'flag': 'X'},
    'XXX': {'name': 'The codes assigned for transactions where no currency is involved', 'flag': 'X'},
